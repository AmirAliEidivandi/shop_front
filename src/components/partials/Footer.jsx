            ...
            <footer className="app-footer bg-dark pb-0 border-0 text-md-left text-center">
                <div className="container">
                    <div className="row align-items-center mb-md-5 mb-3">
                        <div className="col-md-4">
                            <img className="pr-3 mb-md-0 mb-4" src="/static/assets/img/logo-color.png" srcSet="/static/assets/img/logo-color@2x.png 2x" alt="" />
                        </div>
                        <div className="col-md-8">
                            <span className="font-lora h5 font-weight-normal">- یک بسته ساز قدرتمند خلاق برای بوت استرپ 4</span>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-4 mb-md-0 mb-4">
                            <p className="text-muted">یک مجموعه بزرگ و قدرتمند از بسته بندی جزء مدرن برای ساختن وب سایت بهتر برای پروژه بعدی شما</p>
                        </div>
                ...
                <div className="app-secondary-footer mt-md-5 mt-3">
                    <div className="container">
                        <div className="row">
                            <div className="col">
                                <span className="copyright">تمامی حقوق کلاب محفوظ است</span>
                            </div>
                        </div>
                    </div>
                </div>
